...
export function Banner({toggle_overlay}:{toggle_overlay:()=>void;}) {
    ...
    return <><div className={`${style.banner}  ${oldEnglish.className}`}>
        <div className={`${style.bannerElement} ${style.bannerLeft} `}><div className={`${style.imagecontainer}`} onClick={toggle_overlay}><img src='https://i.imgur.com/6XjOtdA.png' alt="menuIcon"></img></div></div>
