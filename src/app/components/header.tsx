...
export function Header() {
    const [overlay_width,set_overlay_width] = useState("0");
      ...
      const links = [["/auction","Auksjonsobjekter","Auksjon"], ["/live-auction","Live auksjon","Live"],["/put-item-for-auction","Legg ut for salg","Selg"],["/kappe-side","Kapper","Kapper"],["/statistics","Statistikk"],["/stretchgoals","Stretch goals"],["/charity","Årets veldedighet"],["/about","Om auksjonen"],["/",""]]
