...
export default function App() {
    ...
    return (
        <div>
            ...
            <h3 className={style.promoText}> Oi oi oi. Det selges ting live! Da kan du møte opp og by live! Akkuratt som storage wars!(Vevcom gir ingen garanti på livauksjonens likhet til det amerikanske tv programmet storage wars). Møt opp __sett_inn_sted___</h3>
