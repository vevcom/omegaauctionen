...
export default function about() {
    return <div className={style.content}>
        ...
        <p className={style.explainationText}>Alle med feidebruker innad NTNU. Auksjonen er primært for medlemmer av omega, men hvis du har en NTNUbruker er du velkommen til å delta! :)</p>
