...
export default function Charity() {
    ...
    <div className={style.titleCard}>
        ...
        <p className={style.tekst}> I år samarbeider Scanctus Omegas Broderskap igjen med Gi Effektivt. Gi Effektivt er en veldedig organisasjon som jobber med å gjøre det enkelt og effektivt å gi penger til humanitære saker. I år går pengene til prosjektet Malaria Consortium:</p>
        ...
        <p className={style.tekst}>Det koster 60 til 70 kroner å beskytte et barn mot malaria i én sesong, og bistandsevaluatoren GiveWell estimerer at Malaria Consortium sitt program for å dele ut forebyggende medisin mot malaria i gjennomsnitt redder et liv for rundt 50 000 kroner.</p>
